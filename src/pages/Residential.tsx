...
const Residential: React.FC = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 px-6 bg-gradient-to-r from-rose-600 to-rose-800">
        <div className="max-w-5xl mx-auto text-center text-white">
          <h1 className="text-5xl md:text-6xl font-light mb-6">Residential</h1>
