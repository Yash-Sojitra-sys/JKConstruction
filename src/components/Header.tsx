...
const Header: React.FC<HeaderProps> = ({ isTransparent = false }) => {
  ...
  const shouldBeTransparent = isTransparent && !isScrolled && location.pathname === '/';
          ...
          <nav className="flex-1 flex flex-col justify-center space-y-6">
            ...
            <div className={`transform transition-all duration-700 delay-200 ${
              ...
              <div className="space-y-3">
                ...
                <div className={`overflow-hidden transition-all duration-500 ease-out ${
                  expandedMenus.about ? 'max-h-28 opacity-100 transform translate-y-0' : 'max-h-0 opacity-0 transform -translate-y-4'
                }`}>
            ...
            <div className={`transform transition-all duration-700 delay-300 ${
              ...
              <div className="space-y-3">
                ...
                <div className={`overflow-hidden transition-all duration-500 ease-out ${
                  expandedMenus.services ? 'max-h-36 opacity-100 transform translate-y-0' : 'max-h-0 opacity-0 transform -translate-y-4'
                }`}>
                  <div className="ml-6 space-y-2 text-base text-gray-600 pt-2">
                    <Link 
          ...
          <div className={`mt-auto pt-6 border-t border-gray-200 transform transition-all duration-700 delay-700 ${
            ...
            <div className="text-gray-700 space-y-2">
              ...
              <div className="text-gray-600 space-y-1 text-sm">
                <p>300 Banyan Boulevard</p>
                <p>Suite 1101</p>
                <p>West Palm Beach, FL 33401</p>
                <p className="mt-3"><span className="font-medium">T:</span> 561.627.7171</p>
                <p><span className="font-medium">E:</span> info@jaykrishnaconstruction.com</p>
              </div>
            </div>
          </div>
        </div>
